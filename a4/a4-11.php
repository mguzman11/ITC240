...
echo '
   	...
   	Enter the first number:<input type="text" name="num1" required="required"><br>
...
/* Line    
    ...
    8. Line 17's name attribute for the name variable needs to be lowercase. 
    
    9. method ="post" needs to be added to line 16. 
    
    10. Line 17 needs a required attribute so that if it is missed, an error does not happen. 
 */   
?>
